...
class JingxiOrderForm extends Component {

  constructor(props, context) {
    super(props, context)
    this.messages = context.intl.messages
    this.lang = context.intl.lang
    this.state = {jingxi:[],paytype:true}
  }
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="payways-btn">
          ...
          <div className="btns clearfloat">
            <div className={classnames({'btn':true,'float-l':true,'cur':this.state.paytype})} onClick={(e) => this.changePayType(true)}>
...
JingxiOrderForm.contextTypes = {
  intl: React.PropTypes.object.isRequired
}

export default reduxForm({
  form: 'addJingxiOrderForm',
  fields,
  onSubmit: submitForm,
  validate,
  destroyOnUnmount: false,
}, mapStateToProps, mapDispatchToProps)(JingxiOrderForm)
